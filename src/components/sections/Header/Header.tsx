    ...
    return (
        <header id="#top">
            <nav className={`w-full fixed z-[999] transition-all duration-300 px-12 2xl:px-[6%] flex items-center justify-center h-[12vh] min-h-[4rem] mdlg:justify-between ${theme === 'dark' ? 'dark bg-zinc-800' : 'bg-gray-300'}`}>
                <a href="#top" className="text-center text-transparent text-2xl 2xl:text-xlg bg-clip-text gradient-text transition-all duration-300 hover:scale-105 mdlg:text-left">Bernardo</a>
                ...
                <ul className={
                    ...
                    <ItemUl state={State} link="Materias">
                        {
                            language === "English"
                                ?
                                "Subjects"
                    ...
                    <ItemUl state={State} link="Aprendizado">
                        {
                            language === "English"
                                ?
                                "Lerning"
                    ...
                    <div className={
                        ...
                        <li className="text-xxl">
                            <a href="https://github.com/Berdegeus" rel="noopener noreferrer" target="_blank">
                                <LinearGradientIcon
