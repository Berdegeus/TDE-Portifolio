            ...
            <div>
                ...
                <div className="flex items-center flex-col justify-center w-full p-4 pb-2 md:flex-row lg:p-6">
                    ...
                    >
                        ...
                        <Text text={{ Portugues: "Caso queira entrar em contato comigo me mande uma mensagem 🚀.", English: "If you'd like to get in touch with me, send me a message🚀." }} className="text-center px-4 sm:px-12 md:text-start md:px-0" size="md" />
                        <div className="flex flex-col gap-4 items-center justify-start mt-8">
                            <div className="flex gap-2 items-center justify-start w-full">
                                <LinearGradientIcon
                                    ...
                                    size={28}
                                />
                                <Text text={{ English: "berdegeus@gmail.com", Portugues: "berdegeus@gmail.com" }} className="text-md xs:text-lg" size="md" />
                            </div>
                            <div className="flex gap-2 items-center justify-start w-full">
                                <LinearGradientIcon
                                    id={"6"}
                                    ...
                                    size={30}
                                />
                                <Text text={{ English: "Curitiba, Parana - Brazil", Portugues: "Curitiba, Paraná - Brasil" }} className="text-md xs:text-lg" size="md" />
                            </div>
                        </div>
                    </motion.div>
                    <motion.form
                        action="https://formsubmit.co/berdegeus@gmail.com"
                        ref={Form}
                        method="POST"
